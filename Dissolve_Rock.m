...
Zeros_Mat = (Previous_Rock_Matrix == 0);
Dissolved_Neighbours = zeros(size(Previous_Rock_Matrix ));
Dissolved_Neighbours(2:end - 1,2:end - 1) =... 
                        Zeros_Mat(1:end - 2,1:end - 2) +...
                        Zeros_Mat(1:end - 2,2:end - 1) +...
                        Zeros_Mat(1:end - 2,3:end) +...
                        Zeros_Mat(2:end - 1,1:end - 2) +...
                        Zeros_Mat(2:end - 1,3:end) +...
                        Zeros_Mat(3:end,1:end - 2) +...
                        Zeros_Mat(3:end,2:end - 1) +...
                        Zeros_Mat(3:end,3:end);
